...
✓ tests/gateway/test_telegram_business.py (80✓, 2.1s)

=== Summary: 4 files, 219 tests passed, 0 failed (0% complete) in 2.1s (32 workers) ===
```
...
- Owner/manual classification independent of legacy self-ignore flag: covered by `test_business_classifier_owner_identity_ignores_legacy_self_ignore_gate`; passed.
