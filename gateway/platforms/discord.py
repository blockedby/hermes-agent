...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def _handle_message(self, message: DiscordMessage) -> None:
        ...
        if not is_thread and not isinstance(message.channel, discord.DMChannel):
            ...
            # Free-response channels are intended to behave like normal inline
            # chat rooms: they bypass the @mention gate but should not spin up
            # a new auto-thread for every message that happens to be accepted.
